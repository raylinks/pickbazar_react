...
const classes = {
  ...
  minimal:
    'bg-gray-100 ps-10 pe-4 md:ps-14 border border-transparent focus:border-accent focus:bg-light',
    ...
    <form onSubmit={onSubmit} className={cn('w-full', className)}>
      ...
      >
        ...
        <input
          ...
          autoComplete="off"
          className={cn(
            'search w-full h-full flex item-center appearance-none transition duration-300 ease-in-out text-heading text-sm placeholder-gray-500 overflow-hidden rounded-lg focus:outline-none focus:ring-0 truncate',
            classes[variant]
          )}
          {...rest}
        />
