...
const variantClasses = {
  ...
  bordered:
    'h-14 rounded text-heading bg-transparent inline-flex justify-between flex-shrink-0',
};
    ...
    >
      <button
        ...
        className={cn(
          'cursor-pointer p-2 transition-colors duration-200 focus:outline-none hover:bg-accent-hover',
          {
            ...
            'px-5': variant === 'big',
            'px-5 border border-gray-300 rounded-s hover:!bg-transparent hover:border-accent':
              variant === 'bordered',
      ...
      <div
        className={cn(
          ...
          variant === 'bordered' &&
            'text-heading px-8  border-t border-b border-gray-300'
        )}
      >
        {value}
      </div>
      <button
        ...
        className={cn(
          'cursor-pointer p-2 transition-colors duration-200 focus:outline-none hover:bg-accent-hover',
          {
            'px-3 py-3 sm:px-2': variant === 'single',
            'px-5': variant === 'big',
            'px-5 border border-gray-300 rounded-e hover:!bg-transparent hover:!text-accent hover:border-accent':
              variant === 'bordered',
            'hover:!bg-gray-100': variant === 'pillVertical',
          }
        )}
