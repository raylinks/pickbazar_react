  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'flex justify-between items-center w-full h-14 md:h-16 lg:h-22 px-4 lg:ps-16 lg:pe-16 py-5 bg-light  transition-transform duration-300 relative z-10'
          )}
        >
            ...
            >
              ...
              >
                ...
                {(item?.columns || item.subMenu) && (
                  <span className="opacity-30 text-heading text-xs mt-1 xl:mt-0.5 ms-1.5 w-2.5 flex justify-end">
              ...
              {item?.subMenu && Array.isArray(item.subMenu) && (
                <div className="subMenu shadow-md border border-gray-200 bg-white absolute start-0 opacity-0 group-hover:opacity-100">
